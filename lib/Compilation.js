...
/**
 * @typedef {(err: Error|null, result: Module) => void } ModuleFactoryCreateCallback
 */

/**
 * @typedef {{create: (data: any, callback: Function) => ModuleFactoryCreateCallback }} ModuleFactory
 */
